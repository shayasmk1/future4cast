...
<html>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 login-form-margin">
           
            <div class="panel panel-default ">
                 
                <div class="panel-heading"> <strong class="">Admin Login</strong>
                ...
                <div class="panel-body">
                    ...
                    <form action='/auth/admin' method='post' class='form-horizontal' role='form'>
